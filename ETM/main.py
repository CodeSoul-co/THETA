...
def load_texts(config: PipelineConfig, logger: logging.Logger) -> Tuple[List[str], Optional[np.ndarray]]:
...
def run_evaluation(
    ...
    if os.path.exists(bow_path):
        ...
        texts, _ = load_texts(config, logger)
...
def run_visualization(
    ...
    logger.info("Generated document-topic visualization")
