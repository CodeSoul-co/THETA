# THETA 0.3.2 · Desktop Preview

**English** | [中文](https://github.com/CodeSoul-co/THETA/blob/main/docs/releases/desktop-v0.3.2.zh.md)
...
| --- | --- | --- |
| macOS Apple Silicon | [DMG](https://github.com/CodeSoul-co/THETA/releases/download/desktop-v0.3.2/THETA-0.3.2-mac-arm64.dmg) | Open the DMG and drag THETA into Applications |
| Windows x64 | [EXE](https://github.com/CodeSoul-co/THETA/releases/download/desktop-v0.3.2/THETA-0.3.2-win-x64.exe) | Run the installer |

The macOS ZIP is an alternative app archive; use the DMG for a standard installation. [SHA256SUMS.txt](https://github.com/CodeSoul-co/THETA/releases/download/desktop-v0.3.2/SHA256SUMS.txt) contains checksums for each installer. Source archives do not include the desktop runtime.
