#!/bin/bash
# THETA Quick Start - Chinese Dataset
# Complete workflow for a new Chinese dataset
...
echo "  $DATA_DIR/$DATASET/${DATASET}_cleaned.csv"
...
if [ -z "$CSV_FILE" ]; then
    echo "Error: No CSV file found in $DATA_DIR/$DATASET/"
...
echo "  $RESULT_DIR/0.6B/$DATASET/zero_shot/"
echo ""
echo "Evaluation metrics:"
echo "  $RESULT_DIR/0.6B/$DATASET/zero_shot/metrics/"
echo ""
echo "Visualizations:"
echo "  $RESULT_DIR/0.6B/$DATASET/zero_shot/visualizations/"
echo "=========================================="
