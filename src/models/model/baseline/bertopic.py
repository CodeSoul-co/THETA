...
class BERTopicModel(TraditionalTopicModel):
    ...
    def fit(
        ...
        **kwargs
        ...
        # Use the same automatic multilingual policy as BOW preparation.
        # The chart display language must not select a text tokenizer.
        from sklearn.feature_extraction.text import CountVectorizer
        from utils.stopword_manager import StopwordManager
        stopwords = StopwordManager()
        stopwords.detect_language_from_documents(texts)
        stopwords.load_stopwords()
        self.model.vectorizer_model = CountVectorizer(
            tokenizer=stopwords.process_text, token_pattern=None, lowercase=False
        )
