...
class EmbeddingProcessor:
    ...
    def _detect_model_path(self) -> str:
        ...
        embedding_models_dir = os.environ.get('EMBEDDING_MODELS_DIR', os.path.join(project_root, 'embedding_models'))
        
        possible_paths = [
            # Embedding models directory (preferred)
            os.path.join(embedding_models_dir, local_name),
            # Project directory
