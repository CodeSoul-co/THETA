...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to Qwen3-Embedding model (default: from environment)"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output directory for embeddings (default: from environment)"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Result directory (default: from environment)"
    )
