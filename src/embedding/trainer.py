...
class TrainingConfig:
    ...
    # Output - defaults to data/workspace directory structure
    output_dir: str = field(default_factory=lambda: os.path.join(os.environ.get('PROJECT_ROOT', os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'data', 'workspace', 'default_user', 'default_dataset', 'embeddings'))
    checkpoint_dir: str = field(default_factory=lambda: os.path.join(os.environ.get('PROJECT_ROOT', os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'data', 'workspace', 'default_user', 'default_dataset', 'checkpoints'))
    result_dir: str = field(default_factory=lambda: os.path.join(os.environ.get('PROJECT_ROOT', os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'result'))
