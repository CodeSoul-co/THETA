#!/bin/bash
# Supervised Training - Remaining datasets
# socialTwitter -> hatespeech -> mental_health
...
echo "=========================================="
echo "Supervised Training - Remaining Datasets"
echo "Time: $(date)"
echo "=========================================="
...
print('Time: $(date)')
print('='*70)
" 2>&1 | tee logs/supervised_remaining_$(date +%Y%m%d_%H%M%S).log
